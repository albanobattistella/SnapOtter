...
```bash
curl -X POST http://localhost:13490/api/v1/tools/pdf/pdf-to-image \
  -F "file=@document.pdf" \
...
```bash
curl -X POST http://localhost:13490/api/v1/tools/pdf/pdf-to-image/info \
  -F "file=@document.pdf"
```
...
```bash
curl -X POST http://localhost:13490/api/v1/tools/pdf/pdf-to-image/preview \
  -F "file=@document.pdf"
```
